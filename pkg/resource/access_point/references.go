...
func (rm *resourceManager) ClearResolvedReferences(res acktypes.AWSResource) acktypes.AWSResource {
	...
	if ko.Spec.VPCConfiguration != nil {
		if ko.Spec.VPCConfiguration.VPCRef != nil {
			ko.Spec.VPCConfiguration.VPCID = nil
		}
	}
...
func (rm *resourceManager) EnsureReferences(
	...
	if desiredKO.Spec.VPCConfiguration != nil {
		if desiredKO.Spec.VPCConfiguration.VPCRef != nil {
			if latestKO.Spec.VPCConfiguration == nil {
				latestKO.Spec.VPCConfiguration = &svcapitypes.VPCConfiguration{}
			}
			if latestKO.Spec.VPCConfiguration.VPCRef == nil {
				latestKO.Spec.VPCConfiguration.VPCRef = desiredKO.Spec.VPCConfiguration.VPCRef
			}
		}
	}
...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForVPCConfiguration_VPCID(ctx, apiReader, ko); err != nil {
...
func validateReferenceFields(ko *svcapitypes.AccessPoint) error {
	...
	if ko.Spec.VPCConfiguration != nil {
		if ko.Spec.VPCConfiguration.VPCRef != nil && ko.Spec.VPCConfiguration.VPCID != nil {
			return ackerr.ResourceReferenceAndIDNotSupportedFor("VPCConfiguration.VPCID", "VPCConfiguration.VPCRef")
		}
	}
	return nil
}

// resolveReferenceForVPCConfiguration_VPCID reads the resource referenced
// from VPCConfiguration.VPCRef field and sets the VPCConfiguration.VPCID
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForVPCConfiguration_VPCID(
	ctx context.Context,
	apiReader client.Reader,
	ko *svcapitypes.AccessPoint,
) (hasReferences bool, err error) {
	if ko.Spec.VPCConfiguration != nil {
		if ko.Spec.VPCConfiguration.VPCRef != nil && ko.Spec.VPCConfiguration.VPCRef.From != nil {
			hasReferences = true
			arr := ko.Spec.VPCConfiguration.VPCRef.From
			...
			ko.Spec.VPCConfiguration.VPCID = (*string)(obj.Status.VPCID)
		}
	}
