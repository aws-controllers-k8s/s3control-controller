...
const (
	ObjectLambdaAllowedFeature_GetObjectPartNumber  ObjectLambdaAllowedFeature = "GetObjectPartNumber"
	ObjectLambdaAllowedFeature_GetObjectRange       ObjectLambdaAllowedFeature = "GetObjectRange"
	ObjectLambdaAllowedFeature_HeadObjectPartNumber ObjectLambdaAllowedFeature = "HeadObjectPartNumber"
	ObjectLambdaAllowedFeature_HeadObjectRange      ObjectLambdaAllowedFeature = "HeadObjectRange"
)
...
const (
	S3CannedAccessControlList_AUTHENTICATED_READ        S3CannedAccessControlList = "AUTHENTICATED_READ"
	S3CannedAccessControlList_AWS_EXEC_READ             S3CannedAccessControlList = "AWS_EXEC_READ"
	S3CannedAccessControlList_BUCKET_OWNER_FULL_CONTROL S3CannedAccessControlList = "BUCKET_OWNER_FULL_CONTROL"
	S3CannedAccessControlList_BUCKET_OWNER_READ         S3CannedAccessControlList = "BUCKET_OWNER_READ"
	S3CannedAccessControlList_PRIVATE                   S3CannedAccessControlList = "PRIVATE"
	S3CannedAccessControlList_PUBLIC_READ               S3CannedAccessControlList = "PUBLIC_READ"
	S3CannedAccessControlList_PUBLIC_READ_WRITE         S3CannedAccessControlList = "PUBLIC_READ_WRITE"
)
...
const (
	S3GranteeTypeIdentifier_CANONICAL     S3GranteeTypeIdentifier = "CANONICAL"
	S3GranteeTypeIdentifier_EMAIL_ADDRESS S3GranteeTypeIdentifier = "EMAIL_ADDRESS"
	S3GranteeTypeIdentifier_GROUP         S3GranteeTypeIdentifier = "GROUP"
)
